...
1. 在打开的窗口中，阅读描述并查看与模板相关的信息。  选择页面底部的 **“创建规则”**。
    ...
    1. 在“自动响应”选项卡中，请注意如何添加 playbook 以自动进行响应。  同样，可创建事件自动化规则。  选择“事件自动化”下方的 **“+ 添加”** 新规则。  用于创建新自动化规则的窗口随即打开。  在此页面上创建的任何自动化规则都由你所创建的分析规则触发。请注意，可为该规则添加条件并设置操作。   选择 **“取消”** 退出此窗口。
