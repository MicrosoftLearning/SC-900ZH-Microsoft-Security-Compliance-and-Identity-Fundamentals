...
1. 在左侧导航面板的“创作”下，选择 **“分配”**。  你将看到已经有一个策略分配，请选择 **“ASC 默认”**。  请注意描述字段，它显示“这是 Azure 安全中心监视的一组默认策略”。它是在加入安全中心的过程中自动分配的。默认分配仅包含审核策略。有关详细信息，请访问 https://aka.ms/ascpolicies。  选择页面右上角的 **“X”**，返回到“策略分配”页面。
